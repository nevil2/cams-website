...
A [replacement](https://hi.alpineclub.org/) for the [Alpine Club's](http://alpineclub.org/) Himalayan Index is in development (currently member only).

This enables remote updating on the database by a variety of volunteers, and for member (public in future) submission of comments and photos.

It is a stand-alone SvelteKit website, supported by a separate Hono server using D1 database and R2 storage (all deployed on cloudflare).

</div>
<div class="w-full sm:w-1/2">

[![Himalayan Index application](himalayan.png)](https://hi.alpineclub.org/)
</div>
</div>
...
[![Munros submission application](munros.png)](https://smc.org.uk/hills/submission)
</div>
...
[![SMC full routes website](smc_full_routes.png)](https://routes.smc.org.uk/)
</div>
</div>
...
[![Wired Guides website](wired_website.png)](https://wired-guides.com/)
</div>
